...
(function() {
  var ambientLight, aspectRatio, camera, colorToVector3, contentEl, controls, effectComposer, fragmentShader, height, material, modelPass, parameters, plane, pointLight, render, renderTarget, renderer, scene, screenPass, socket, sphere, uniforms, vertexShader, viewAngle, vignettePass, width;
  ...
  socket.on('shader', function(type, shader) {
    if (type === 'vertex') {
